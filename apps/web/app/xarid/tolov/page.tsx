                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
                  ...
                  {tQoldiq && (
                    <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap", justifyContent: "flex-end" }}>
                      ...
                      {tQoldiq.som !== 0 && (
                        <span style={{ fontSize: 12, fontWeight: 800, color: tQoldiq.som > 0 ? "#ef4444" : "#16a34a" }}>
                          {tQoldiq.som.toLocaleString("ru-RU")} so&apos;m
                        </span>
                      )}
                      {tQoldiq.usd !== 0 && (
                        <span style={{ fontSize: 12, fontWeight: 800, color: tQoldiq.usd > 0 ? "#ef4444" : "#16a34a" }}>
                          {fmtUsd(tQoldiq.usd)}
                        </span>
                      )}
